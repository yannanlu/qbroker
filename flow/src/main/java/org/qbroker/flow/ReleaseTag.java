 ...
 * ConfigTemplate and updated its main() for testing, fixed an issue with
 * SyntheticMonitor for the in-line template on the config file, added
 * StaticDependencyGroup to MonitorGroup
 *<br>
