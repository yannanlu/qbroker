...
public class JMXQMonitor extends Monitor {
    ...
    public static void main(String args[]) {
        ...
        if (filename == null)
            ...
            report = (MonitorReport) new JMXQMonitor(ph);
    ...
    private static void printUsage() {
        System.out.println("JMXQMonitor Version 1.0 (written by Yannan Lu)");
        System.out.println("JMXQMonitor: monitor a queue via JMX");
        System.out.println("Usage: java org.qbroker.monitor.JMXQMonitor -I cfg.json");
    }
}
