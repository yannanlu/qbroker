...
public class NumberMonitor extends Monitor {
    ...
    public static void main(String[] args) {
        ...
        if (filename == null)
            ...
            report = (MonitorReport) new NumberMonitor(ph);
    ...
    private static void printUsage() {
        System.out.println("NumberMonitor Version 1.0 (written by Yannan Lu)");
        System.out.println("NumberMonitor: monitor a number");
        System.out.println("Usage: java org.qbroker.monitor.NumberMonitor -I cfg.json");
    }
}
